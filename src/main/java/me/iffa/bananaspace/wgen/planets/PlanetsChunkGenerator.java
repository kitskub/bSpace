...
public class PlanetsChunkGenerator extends ChunkGenerator {
    ...
    private void generatePlanetoids(World world, int x, int z){
        ...
        System.out.println("BananaSpace Chunk "+x+" "+z);
        //Seed shift;
        ...
        SpaceMessageHandler.debugPrint(Level.INFO, "Made " + planetoids.size() + " planets in this chunk.");
        SpaceMessageHandler.debugPrint(Level.INFO, "Planets: " + planets.get(world).size());
