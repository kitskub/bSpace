...
public class PlanetsChunkGenerator extends ChunkGenerator {
    ...
    public List<BlockPopulator> getDefaultPopulators(World world) {
        ...
        if (SpaceConfigHandler.getGenerateBlacks(world) && SpaceConfigHandler.isUsingSpout() && Bukkit.getPluginManager().getPlugin("Spout") != null) {
            populators.add(new SpaceBlackHolePopulator(Bukkit.getPluginManager().getPlugin("bSpace")));
        }
        return populators;
    }
